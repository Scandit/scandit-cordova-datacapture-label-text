...
for candidate in [
    "framework",
    "ScanditLabelTextPlugin-Bridging-Header.h",
    "scandit-cordova-datacapture-label-text-framework.podspec",
...
targets.insert(
    .target(
        name: "ScanditCordovaDatacaptureLabelText",
...
let package = Package(
    name: "scandit-cordova-datacapture-label-text",
    platforms: [.iOS(.v15)],
    products: [
        .library(
            name: "scandit-cordova-datacapture-label-text",
            targets: ["ScanditCordovaDatacaptureLabelText"]
        )
    ],
